<?php
App::uses('DoctorConsultLocationsController', 'Controller');

/**
 * DoctorConsultLocationsController Test Case
 *
 */
class DoctorConsultLocationsControllerTest extends ControllerTestCase {
