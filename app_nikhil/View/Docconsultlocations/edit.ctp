...
<?php echo $this->Form->create('Docconsultlocation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Docconsultlocation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Docconsultlocation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Docconsultlocation.id'))); ?></li>
