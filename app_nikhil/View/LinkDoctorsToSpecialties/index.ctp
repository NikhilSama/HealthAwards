<div class="linkDoctorsToSpecialties index">
	<h2><?php echo __('Link Doctors To Specialties'); ?></h2>
	...
	<?php
	foreach ($linkDoctorsToSpecialties as $linkDoctorsToSpecialty): ?>
	<tr>
		<td><?php echo h($linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['created']); ?>&nbsp;</td>
		<td><?php echo h($linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['id']), null, __('Are you sure you want to delete # %s?', $linkDoctorsToSpecialty['LinkDoctorsToSpecialty']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
